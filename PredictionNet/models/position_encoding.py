...
class PositionEmbeddingLearned(nn.Module):
    ...
    def __init__(self, num_pos_feats=256, type=0):  # mhsa:2048
        super().__init__()
...
def build_position_encoding(args):
    ...
    elif args.position_embedding in ('v4', 'peg'):
        position_embedding = PosCNN(args.dim_feedforward)
    else:
